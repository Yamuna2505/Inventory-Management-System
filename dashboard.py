...
class IMS:
    def __init__(self,root):
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Mapadini Yamuna\nFor any Technical Issues Contact: 9876543210",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
